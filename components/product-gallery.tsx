...
export function ProductGallery({ product }: Props) {
  const [selectedImage, selectedImageSet] = useState(0)
  return (
    <div className="flex flex-col-reverse">
        ...
        <ul className="grid grid-cols-4 gap-6">
          {product.images.map((image, index) => (
            <div
              ...
              onClick={() => selectedImageSet(index)}
      ...
      <div className="h-[600px] w-full overflow-hidden">
        <Image
          ...
          width={600}
          height={600}
          className="h-full w-full border-2 border-gray-200 object-cover dark:border-gray-800 sm:rounded-lg"
        />
      </div>
    </div>
  )
